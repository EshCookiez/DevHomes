          ...
          <>
            ...
            <div className="space-y-6 px-6 py-6">
              <div className="grid gap-4 md:grid-cols-2">
                <DetailCard label="Sender" value={inquiry.sender_name || 'Unknown sender'} />
                <DetailCard label="Listing" value={inquiry.listing_title || 'Not linked'} />
                <DetailCard label="Project" value={inquiry.project_name || 'Not linked'} />
                <DetailCard label="Inquiry Date" value={formatDate(inquiry.created_at)} />
                <DetailCard label="Queue" value={inquiry.queue_level === 'main_queue' ? 'Main Queue' : inquiry.queue_level === 'suboffice_queue' ? 'Suboffice Queue' : 'Assigned'} />
                <DetailCard label="Routing Office" value={inquiry.routing_office_name || 'Main Office'} />
                <DetailCard label="Assigned Agent" value={inquiry.assigned_agent || 'Unassigned'} />
                <DetailCard label="Assigned By" value={inquiry.assigned_by_name || 'Not recorded'} />
              </div>
