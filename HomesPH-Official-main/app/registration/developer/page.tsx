        ...
        <div className="lg:hidden relative bg-gradient-to-br from-[#0c1f4a] via-[#0f2856] to-[#052539] px-6 pt-10 pb-20 text-center overflow-hidden select-none">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-200/70 text-sm mt-3 max-w-xs mx-auto leading-relaxed">
              List your developments on the Philippines' fastest-growing real estate platform.
            </p>
          </div>
        </div>
          ...
          <div className="relative z-10 w-full max-w-2xl mx-auto flex flex-col justify-between p-14 xl:p-20">
            <div className="flex-1 flex flex-col justify-center">
              ...
              <h2 className="text-5xl xl:text-6xl font-black leading-[1.08] tracking-tight text-white">
                Build More.
                <br />
                <span className="text-[#f59e0b]">Sell Faster.</span>
                <br />
                Scale Up.
              </h2>
              <p className="mt-6 text-blue-200/80 text-base xl:text-lg max-w-sm leading-relaxed">
                Showcase your condominiums, townhouses, and subdivision projects to thousands of active homebuyers across the Philippines.
              </p>
              <div className="flex items-center gap-6 mt-8">
                <div>
                  <p className="text-white font-black text-2xl leading-none">500+</p>
                  <p className="text-blue-300/60 text-xs mt-1">Developers</p>
                </div>
                <div className="w-px h-8 bg-white/20" />
                <div>
                  <p className="text-white font-black text-2xl leading-none">50K+</p>
                  <p className="text-blue-300/60 text-xs mt-1">Happy Buyers</p>
                </div>
                <div className="w-px h-8 bg-white/20" />
                <div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.06] backdrop-blur-sm p-6">
              ...
              <p className="text-blue-100/90 text-sm leading-relaxed italic">
                "Partnering with HomesPH tripled our online inquiries. Their platform connects us directly with serious buyers."
              </p>
              <div className="mt-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-white text-xs font-semibold">Jose Lim</p>
                  <p className="text-blue-300/60 text-xs">CEO · Visayas Property Group</p>
                </div>
              </div>
            </div>
          </div>
